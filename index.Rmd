...
<br>
![Data Structure Representation](docs/Data_Structure.PNG)<br>
{r}[Backup link] (https://github.com/geo511-2019/2019-geo511-project-austin3087/blob/master/docs/Data_Structure.PNG)
```{r, warning = FALSE, message = FALSE}
...
```{r, fig.width=7.775, fig.height=4, echo = FALSE, warning = FALSE, fig.fullwidth = TRUE}
plot1
```
<br><br>
