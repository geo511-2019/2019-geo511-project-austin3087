...
<br>
![Data Structure Representation](docs/Data_Structure.PNG)
...
theme_black_blank<- theme(plot.background = element_rect(fill = element_blank()), panel.background = element_rect(fill = element_blank()),panel.border = element_rect(fill = element_blank()), panel.grid = element_line(color = element_blank()), axis.title = element_blank(), plot.margin = unit(c(0,0,0,0),"cm"), axis.text = element_blank(), axis.line = element_blank(), legend.position = "none")
