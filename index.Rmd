...
```{r, fig.width=7.5, fig.height=3.88, echo = FALSE, warning = FALSE, fig.fullwidth = TRUE, fig.fullheight = TRUE, fig.align="center"}
plot1
```
<br>
<br>
...
```{r, fig.width=7.5, fig.height=3.88, echo = FALSE, warning = FALSE, fig.align="center"}
plot2
```
<br>
<br>
